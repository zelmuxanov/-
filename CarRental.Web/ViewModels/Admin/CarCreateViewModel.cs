...
public class CarCreateViewModel
{
    ...
    public List<CarImageDto>? UploadedImages { get; set; }
    ...
    public string EngineCapacityString { get; set; } = "2.0"; // Изменено на string!
    ...
    public IEnumerable<string>? ExistingBrands { get; set; }
    public IEnumerable<string>? ExistingModels { get; set; }
